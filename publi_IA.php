...
<!-- /.container -->
	...
	<h1 class="text-center">Listado de Archivos</h1>
		...
		$sql="SELECT * FROM tbl_uploads where categoria = 'Inteligencia artificial y Derecho'";
		...
		if ($result_rows > 0){
			...
			<div class="panel panel-primary">
				  ...
				  <div class="panel-heading text-center" style="max-height: 200;">Inteligencia Artificial y Derecho</div>
